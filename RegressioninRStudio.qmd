...
title(main = "Dataset 1: Wolf vs Prey Spiders")
...
plot(Time~Predators, data = Dataset_3)
title(main = "Time Spent Foraging vs. Birds of Prey Sightings")
results = lm(Time~Predators, data = Dataset_3)
abline(results)
```
...
**For each 1 birds of prey increase measured the preceding day, we observed a 2.81 minute/day increase in time spent foraging by Colombian Squirels (p = 0.106; r\^2 = 0.0117).**
